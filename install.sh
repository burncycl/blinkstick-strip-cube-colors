...
# 2020/06 BuRnCycL
# This will install Packager Maintained Dependencies for blinkstick-strip-cube-colors and facilitate non-root execution.
...
then
	...
	$APT install -y python3 python3-pip python3-virtualenv virtualenv
